...
class MapInfoCreator:
    ...
    def __extract_standard_battle_green_cap(self, nodes):
        ...
        self.__set_game_mode_property('standard_battle', 'green_cap_radius', green_cap_radius)
    ...
    def __extract_standard_battle_red_cap(self, nodes):
        ...
        self.__set_game_mode_property('standard_battle', 'red_cap_radius', red_cap_radius)
        ...
        if team_base_position_node is not None:
            ...
            if team_node is not None:
                ...
                if position_node is not None:
                    return self.__as_parsed_coordinates(position_node)
                position1_node = team_node.find('position1')
                if position1_node is not None:
                    return self.__as_parsed_coordinates(position1_node)
                position2_node = team_node.find('position2')
                if position2_node is not None:
                    return self.__as_parsed_coordinates(position2_node)
        return None
        ...
        if team_base_position_node is not None:
            ...
            if team_node is not None:
                ...
                if radius_node is not None:
                    return self.__as_parsed_coordinates(radius_node)
                radius1_node = team_node.find('radius1')
                if radius1_node is not None:
                    return self.__as_parsed_coordinates(radius1_node)
                radius2_node = team_node.find('radius2')
                if radius2_node is not None:
                    return self.__as_parsed_coordinates(radius2_node)
        return None
